...
# With shadow
drawer.draw_text("Text with Shadow", 50, 420, shadow: true)

# With outline
drawer.draw_text("Text with Outline", 50, 500, outline: true)

# Save output
CrImage::PNG.write("text_decorations_demo.png", img)

puts "Saved: text_decorations_demo.png"
